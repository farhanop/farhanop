<div align="center">
  ...
  <a href="https://github.com/farhanop">
    <img src="assets/banner.svg" alt="Parhan Oktaria Putra - FastAPI & React Fullstack Engineer" width="100%" />
  </a>
  ...
  <p align="center">
    <a href="https://github.com/farhanop">
      <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=19&duration=2800&pause=1000&color=38BDF8&center=true&vCenter=true&width=650&height=40&lines=FastAPI+Backend+%26+React+Frontend+Specialist;Architecting+Scalable+Async+Python+APIs;Designing+Modern+Type-Safe+React+UIs;Core+Engineer+at+UIGM-IT-Dev" alt="Animated Typing Subtitle" />
    </a>
  </p>
...
<table width="100%">
  <tr>
    <td width="50%" valign="top">
      ...
      <p>Core backend contributor at <b><a href="https://github.com/UIGM-IT-Dev">UIGM IT Dev</a></b>, architecting campus-wide production services, API integrations, and robust institutional systems.</p>
    </td>
    <td width="50%" valign="top">
      <h3>🚀 Core Stack Specialization</h3>
      <p>Building high-velocity fullstack platforms using <b>FastAPI (Python 3.12)</b> on the backend and <b>React 18 + TypeScript</b> on the client with strict end-to-end type safety.</p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <h3>⚙️ Backend Architecture</h3>
      <p>Asynchronous event loops, <b>Pydantic V2</b> schema validation, <b>SQLAlchemy ORM</b>, PostgreSQL optimization, Redis pub/sub queues, and ultra-low-latency <b>WebRTC</b> media streaming.</p>
    </td>
    <td width="50%" valign="top">
      <h3>🎨 Modern Frontend Craft</h3>
      <p>Declarative component architecture powered by <b>React</b>, <b>Vite</b>, <b>TanStack Query</b> for server-state synchronization, <b>Tailwind CSS</b>, and polished <b>Shadcn UI</b> design tokens.</p>
    </td>
  </tr>
</table>
...
<div align="center">
  <blockquote>
    ...
    <sub>— Software Craftsmanship &amp; Architectural Rigor</sub>
  </blockquote>

  <br />

  <!-- Animated Dynamic Wave Footer -->
  <img src="https://capsule-render.vercel.app/api?type=waving&color=009688,0284c7,38bdf8&height=90&section=footer" width="100%" alt="Footer Wave Animation" />
</div>
